...
public class ChunkTextTests
{
    ...
    private class NullDbContextFactory : Microsoft.EntityFrameworkCore.IDbContextFactory<Data.TranscriptonatorDbContext>
    {
        public Data.TranscriptonatorDbContext CreateDbContext() => null!;
    }
}
